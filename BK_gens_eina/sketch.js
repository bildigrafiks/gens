...
function gotData(data) {
  ...
  slider1Label.html(`<b>Velocitat del vent</b> ${windSpeed}m/s`);
  if (perlinRadius > 150) {
  ...
  descriptionText.html(
    `<b>Mediona, Alt Penedès.</b> ${description}.<br>Long:${weather.coord.lon} Lat: ${weather.coord.lat}  Temp: ${temp} ℃. Humitat: ${humidity} %.<br>Nuvolositat: ${clouds} %. Velocitat del vent: ${windSpeed} m/s.`
  );
